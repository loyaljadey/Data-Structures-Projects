...
public class LinkedListDequeTest {
    ...
    @Test
    /** Test the creation of a LLD. */
    public void LLDequeTest() {
        LinkedListDeque<Integer> lld1 = new LinkedListDeque<Integer>();
    }

    @Test
    /** Test the addition of something to LLD */
    public void LLDequeTestadd() {
        LinkedListDeque<Integer> lld1 = new LinkedListDeque<Integer>();
        lld1.addLast(5);
        lld1.addLast(7);
        lld1.addLast(9);
    ...
    @Test
    /** Test the printing of the LLD */
    public void LLDequeTestprint() {
        LinkedListDeque<Integer> lld1 = new LinkedListDeque<Integer>();
        lld1.addLast(5);
        lld1.addLast(7);
        lld1.addLast(9);
    ...
    @Test
    /** Test the removal of items in the LLD */
    public void LLDequeTestremove() {
        LinkedListDeque<Integer> lld1 = new LinkedListDeque<Integer>();
        lld1.addLast(5);
        lld1.addLast(7);
        lld1.addLast(9);
    ...
    @Test
    /** Test the getting of items in the LLD */
    public void LLDequeTestget() {
        LinkedListDeque<Integer> lld1 = new LinkedListDeque<Integer>();
        lld1.addLast(5);
        lld1.addLast(7);
        lld1.addLast(9);
